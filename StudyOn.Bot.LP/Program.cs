...
namespace Telegram.Bot.Examples.Echo
{
    public static class Program
    {
        ...
        public static async Task Main()
        {
            ...
            var address = "https://localhost:44319/";
            var eventId = "1159AB52-D7F5-4C1C-AB3E-08D8FBEBBE7C";
            var meeting = new MeetingsService(address, eventId);
            var experts = new ExpertService(address, eventId);
            var teams = new TeamService(address, eventId);
            UpdateService = new UpdateService(meeting, teams, experts);
        ...
        public static async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
        {
            ...
            {
                UpdateType.Message => UpdateService.EchoAsync(update, botClient), //BotOnMessageReceived(update.Message),
